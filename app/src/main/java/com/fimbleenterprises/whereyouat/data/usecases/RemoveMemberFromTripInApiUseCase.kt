...
class RemoveMemberFromTripInApiUseCase(private val mainRepository: MainRepository) {

    suspend fun execute(memberid: Long): Flow<Resource<BaseApiResponse>> =
        mainRepository.removeUserFromTripInApi(memberid)
